...
transform([
    ...
    line("'maintenance' => [
        'driver' => 'file',
        // 'store' => 'redis',", 1) => line("'maintenance' => [
        'driver' => env('APP_MAINTENANCE_DRIVER', 'file'),
        // 'store' => env('APP_MAINTENANCE_STORE', 'database'),", 1),
...
transform([
    ...
    line("'redis' => [
            'driver' => 'redis',
            'connection' => 'cache',
            'lock_connection' => 'default',", 2) => line("'redis' => [
            'driver' => 'redis',
            'connection' => env('REDIS_CACHE_CONNECTION', 'cache'),
            'lock_connection' => env('REDIS_CACHE_LOCK_CONNECTION', 'default'),", 2),
...
transform([
    ...
    line("'bcrypt' => [
        ...
        'verify' => true,", 1) => line("'bcrypt' => [
        'rounds' => env('BCRYPT_ROUNDS', 10),
        'verify' => env('HASH_VERIFY', true),", 1),
    line("'argon' => [
        'memory' => 65536,
        'threads' => 1,
        'time' => 4,
        'verify' => true,", 1) => line("'argon' => [
...
transform([
    ...
    line("'partitioned' => false,", 1) => line("'partitioned' => env('SESSION_PARTITIONED_COOKIE', false),", 1),
