...
trait InteractsWithPublishedFiles
{
    ...
    {
        $haystack = $this->app['files']->get($this->getPublishedMigrationFile($file, $directory));
     ...
     */
    protected function getPublishedMigrationFile(string $filename, ?string $directory = null): string
    {
