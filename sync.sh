...
awk '{sub(/\x27QUEUE_CONNECTION\x27, \x27database\x27/,"'\''QUEUE_CONNECTION'\'', '\''sync'\''")}1' laravel/config/queue.php > laravel/config/queue.stub && mv laravel/config/queue.stub laravel/config/queue.php
